...
<body style="padding: 0;" >
		...
		<div class="pinggu-cont">
			...
			<ul class="nav nav-pills nav-stacked nav-stacked-custom" role="tablist" id="myTab">
			  ...
			  <li role="presentation"><a href="#jiegou" role="tab" data-toggle="tab" onclick="onloadmokuai()">医疗结构资源配置</a></li>
			  <li role="presentation"><a href="#shebei" role="tab"  data-toggle="tab" onclick="onloadmokuai()">设备资源配置</a></li>
			  <li role="presentation"><a href="#renli" role="tab" data-toggle="tab" onclick="onloadmokuai()">人力资源配置</a></li>
			  <li role="presentation"><a href="#zhiliao" role="tab" data-toggle="tab" onclick="onloadmokuai()">治疗技术</a></li>
			  <li role="presentation"><a href="#jiance" role="tab" data-toggle="tab" onclick="onloadmokuai()">监测随访技术</a></li>
			  <li role="presentation"><a href="#jiaoxue" role="tab" data-toggle="tab" onclick="onloadmokuai()">教学科研</a></li>
			  <li role="presentation"><a href="#cuzhong" role="tab" data-toggle="tab" onclick="onloadmokuai()">卒中中心质量管理指标</a></li>
			  <li role="presentation"><a href="#zuzhi" role="tab" data-toggle="tab" onclick="onloadmokuai()">组织管理质量</a></li>
			</ul>
			<!-- Tab panes -->
