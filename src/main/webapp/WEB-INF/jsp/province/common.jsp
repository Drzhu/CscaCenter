...
%>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
   	...
   	<nav class="navbar navbar-fixed-top navbar-inverse custom-navbar">
		...
		<div id="sidebar" class="sidebar">
			<ul class="nav-list">
				<li id = "main">
					<a href="main"><i class="fa fa-check-circle"></i> 评估表单审核</a>
				</li>
				<li class="has-sub" id = "ourself_data_feedback">
	            	<a href="javascript:;"><i class="fa fa-database"></i> 本省数据反馈<i class="fa fa-angle-left pull-right right-icon arrow"></i></a>
	            	<ul class="sub">
				...
				<li id = "permission_deal">
					<a href="permission_deal"><i class="fa fa-send"></i> 卒中中心推荐</a>
				</li>
				<li id = "data_quality_monitor">
					<a href="data_quality_monitor"><i class="fa fa-cog"></i> 卒中中心管理</a>
				</li>
				<li id = "hos_info_push">
					<a href="hos_info_push"><i class="fa fa-info-circle"></i> 本省数据申请</a>
				</li>
				<!-- <li id = "hos_question">
	...
	<script src="<%=base %>/js/echart/china.js"></script>
