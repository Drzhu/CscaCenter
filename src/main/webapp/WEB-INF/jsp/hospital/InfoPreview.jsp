			...
			<div class="col-sm-2">
				...
				<div class="col-sm-8">
					<div class="cont-header" style="text-align: center;margin-top: 80px">
						<h3 style="color:257F9C;">医院基本信息</h3>
					</div>
					<hr/>
					<div id="applyEdit">
					 ...
					 <tr>
					 	...
					 	<td colspan="2" style="display: none;"><input class="form-control" type="text" id="pAreaCoding" readonly="readonly"></td>
					 	<td colspan="2" style="display: none;"><input class="form-control" type="text" id="cAreaCoding" readonly="readonly"></td>
					 	<td colspan="2" style="display: none;"><input class="form-control" type="text" id="areaCoding" readonly="readonly"></td>
			...
			url: "select_hInfo",
		 	success: function (res) {
			 	...
			 	if(hospInfo.dist==""){
			 		...
			 		$("#areaName").val(hospInfo.areaName+"-"+hospInfo.city+"-"+hospInfo.dist);
			 	}
				...
				for ( var i in hospInfo) {
					 if(i!="hunitid" && i!="uName" && i!="areaName" && i!="city" && i!="dist" && i!="oldHosp" && i!="hstate" && i!="hlevel" && i!="hDlevel"){
