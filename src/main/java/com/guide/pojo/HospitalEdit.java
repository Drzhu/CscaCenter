 ...
 *
 */
public class HospitalEdit implements Serializable{
    ...
    private String cAreaCoding;
    
    private String pAreaCoding;
	...
	public String getOldHosp() {
		return oldHosp;
	}

	public void setOldHosp(String oldHosp) {
		this.oldHosp = oldHosp;
	}
	...
	public String getcAreaCoding() {
		return cAreaCoding;
	}

	public void setcAreaCoding(String cAreaCoding) {
		this.cAreaCoding = cAreaCoding;
	}

	public String getpAreaCoding() {
		return pAreaCoding;
	}

	public void setpAreaCoding(String pAreaCoding) {
		this.pAreaCoding = pAreaCoding;
	}
	...
	public String getjMDep() {
		return jMDep;
	}

	public void setjMDep(String jMDep) {
		this.jMDep = jMDep;
	}
	...
	public String getJMph() {
		return JMph;
	}

	public void setJMph(String jMph) {
		JMph = jMph;
	}

	public String getjMTjob() {
		return jMTjob;
	}

	public void setjMTjob(String jMTjob) {
		this.jMTjob = jMTjob;
	}
	...
	public String getLinkTjob() {
		return linkTjob;
	}

	public void setLinkTjob(String linkTjob) {
		this.linkTjob = linkTjob;
	}
